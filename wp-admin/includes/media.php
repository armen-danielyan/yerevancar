...
function wp_media_upload_handler() {
	...
	if ( !empty($_POST['insertonlybutton']) ) {
		...
		if ( isset( $_POST['media_type'] ) && 'image' != $_POST['media_type'] ) {
			...
			if ( !empty($src) )
				$html = "<images src='" . esc_url($src) . "' alt='$alt'$class />";
 ...
 * @return string|WP_Error Populated HTML images tag on success, WP_Error object otherwise.
 */
...
function get_media_item( $attachment_id, $args = null ) {
	...
	<table class='slidetoggle describe $class'>
		...
		<tr>
			...
			<p><a href='$attachment_url' target='_blank'><images class='thumbnail' src='$thumb_url' alt='' /></a></p>
...
<?php } ?>
		...
		html = '<images alt="'+alt+'" src="'+f.src.value+'"'+cls+' width="'+t.width+'" height="'+t.height+'" />';
	...
	resetImageData : function() {
		...
		else document.getElementById('status_img').innerHTML = '<images src="<?php echo esc_url( admin_url( 'images/no.png' ) ); ?>" alt="" />';
	},
	...
	updateImageData : function() {
		...
		document.getElementById('status_img').innerHTML = '<images src="<?php echo esc_url( admin_url( 'images/yes.png' ) ); ?>" alt="" />';
	},
	...
	getImageData : function() {
		...
		document.getElementById('status_img').innerHTML = '<images src="<?php echo esc_url( admin_url( 'images/spinner-2x.gif' ) ); ?>" alt="" width="16" height="16" />';
...
function edit_form_image_editor( $post ) {
	...
	<?php
		$quicktags_settings = array( 'buttons' => 'strong,em,link,block,del,ins,images,ul,ol,li,code,close' );
		$editor_args = array(
