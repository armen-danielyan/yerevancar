	...
	public static function editor_settings($editor_id, $set) {
		...
		if ( self::$this_quicktags ) {
			...
			if ( empty($qtInit['buttons']) )
				$qtInit['buttons'] = 'strong,em,link,block,del,ins,images,ul,ol,li,code,more,close';
				...
				self::$first_init = array(
					...
					'formats' => '{' .
						'alignleft: [' .
							...
							'{selector: "images,table,dl.wp-caption", classes: "alignleft"}' .
						'],' .
						'aligncenter: [' .
							'{selector: "p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li", styles: {textAlign:"center"}},' .
							'{selector: "images,table,dl.wp-caption", classes: "aligncenter"}' .
						'],' .
						'alignright: [' .
							'{selector: "p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li", styles: {textAlign:"right"}},' .
							'{selector: "images,table,dl.wp-caption", classes: "alignright"}' .
						'],' .
