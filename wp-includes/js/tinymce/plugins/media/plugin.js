...
tinymce.PluginManager.add('media', function(editor, url) {
	...
	function showDialog() {
		...
		win = editor.windowManager.open({
			...
			onSubmit: function() {
				...
				beforeObjects = editor.dom.select('images[data-mce-object]');
				editor.insertContent(dataToHtml(this.toJSON()));
				afterObjects = editor.dom.select('images[data-mce-object]');
	...
	editor.addButton('media', {
		...
		onclick: showDialog,
		stateSelector: ['images[data-mce-object=video]', 'images[data-mce-object=iframe]']
	});
