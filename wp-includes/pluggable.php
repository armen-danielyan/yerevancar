...
/**
 * Retrieve the avatar `<images>` tag for a user, email address, MD5 hash, comment, or post.
 *
 * @since 2.5.0
 ...
 * @param string $alt        Optional. Alternative text to use in &lt;images&gt; tag. Default empty.
 * @param array  $args       {
 ...
 *                                       Default null.
 *     @type array|string $class         Array or string of additional classes to add to the &lt;images&gt; element.
 *                                       Default null.
 *     @type bool         $force_display Whether to always show the avatar - ignores the show_avatars option.
 *                                       Default false.
 *     @type string       $extra_attr    HTML attributes to insert in the IMG element. Is not sanitized. Default empty.
 * }
 * @return false|string `<images>` tag for the user's avatar. False on failure.
 */
function get_avatar( $id_or_email, $size = 96, $default = '', $alt = '', $args = null ) {
	...
	$avatar = sprintf(
		"<images alt='%s' src='%s' srcset='%s' class='%s' height='%d' width='%d' %s/>",
		esc_attr( $args['alt'] ),
		esc_url( $url ),
		esc_attr( "$url2x 2x" ),
		esc_attr( join( ' ', $class ) ),
	 ...
	 *
	 * @param string $avatar      &lt;images&gt; tag for the user's avatar.
	 * @param mixed  $id_or_email The Gravatar to retrieve. Accepts a user_id, gravatar md5 hash,
	 *                            user email, WP_User object, WP_Post object, or WP_Comment object.
